...
/* ============================================================
   ...
   ============================================================ */
const SITE_VERSION = '4.2.14';

/* -------- NAV + FOOTER -------- */
function injectShell(activePage) {
  // Script partenaire GetYourGuide : uniquement sur les pages qui portent des liens GYG.
  if (document.querySelector('a[href*="getyourguide.com"]')) {
