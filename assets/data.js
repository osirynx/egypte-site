...
window.GODS = [
  {sym:'❂', name:'Ramsès II',      role:'Pharaon divinisé',
  ...
  {sym:'𓂀', name:'Horus',          role:'Dieu faucon',
  ...
  {sym:'𓆋', name:'Sobek',          role:'Dieu crocodile',
   ...
   vu:"Vu à : Kom Ombo"},
  {sym:'𓊨', name:'Isis',           role:'Déesse de la magie',
  ...
  {sym:'𓁹', name:'Osiris',         role:'Dieu des morts',
  ...
  {sym:'☥', name:'Toutankhamon',   role:'Pharaon mystérieux',
  ...
  {sym:'𓆄', name:'Maât',           role:'Déesse de la justice',
  ...
  {sym:'♀', name:'Hatchepsout',    role:'Pharaonne',
