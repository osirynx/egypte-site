...
window.GODS = [
  {sym:'❂', name:'Ramsès II',      role:'Pharaon divinisé',      epoch:'1279–1213 av. J.-C.',
   img:'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Abu_Simbel%2C_Ramesses_II_on_the_front.jpg/800px-Abu_Simbel%2C_Ramesses_II_on_the_front.jpg',
  ...
  {sym:'𓂀', name:'Horus',          role:'Dieu faucon',            epoch:'Dieu primordial',
   img:'https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Horus_E_3840_mp3h8831.jpg/600px-Horus_E_3840_mp3h8831.jpg',
  ...
  {sym:'𓆋', name:'Sobek',          role:'Dieu crocodile',         epoch:'Ancien Empire',
   img:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Sobek2.jpg/500px-Sobek2.jpg',
  ...
  {sym:'𓊨', name:'Isis',           role:'Déesse de la magie',     epoch:'Dieu primordial',
   img:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Isis_with_Horus_the_child_sculpture_in_the_Louvre.jpg/600px-Isis_with_Horus_the_child_sculpture_in_the_Louvre.jpg',
  ...
  {sym:'𓁹', name:'Osiris',         role:'Dieu des morts',         epoch:'Dieu primordial',
   img:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Osiris-don-Eal.jpg/400px-Osiris-don-Eal.jpg',
  ...
  {sym:'☥', name:'Toutankhamon',   role:'Pharaon mystérieux',     epoch:'XVIIIe dynastie, ~1332 av. J.-C.',
   img:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/CairoEgMuseumTaaMaskMostlyPhotographed.jpg/600px-CairoEgMuseumTaaMaskMostlyPhotographed.jpg',
  ...
  {sym:'𓆄', name:'Maât',           role:'Déesse de la justice',   epoch:'Ancien Empire',
   img:'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Maat.svg/500px-Maat.svg.png',
  ...
  {sym:'♀', name:'Hatchepsout',    role:'Pharaonne',               epoch:'XVIIIe dynastie, 1479–1458 av. J.-C.',
   img:'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Mortuary_Temple_of_Hatshepsut_front.JPG/800px-Mortuary_Temple_of_Hatshepsut_front.JPG',
...
window.INFOS = [
  {ic:'✈', t:'Vols & Transports', items:[
    'Nice → Le Caire via Francfort (Lufthansa)',
    "Le Caire → Assouan avec Air Cairo (vol intérieur, repas inclus)",
    'Uber > Taxi toujours (plus safe, prix fixé)',
    'Négocier les taxis locaux AVANT de monter',
    'Métro du Caire : 10 LE le ticket (propre, rapide)',
    'Éviter les tuk-tuks (chaos, arnaque)',
    'Taxi Louxor rive Ouest → bateau → rive Est : 100 LE',
  ]},
  {ic:'✦', t:'Hébergements', items:[
    'Le Caire : choisir un hôtel proche des pyramides — la vue sur Gizeh depuis la chambre vaut tout',
    'Assouan : les petites guest houses près du souk sont charmantes et authentiques',
    'Croisière Nil : bateau, cabine avec mini-pont sur le Nil',
    "Louxor : privilégier la rive Ouest pour la Vallée des Rois, traversée en bac depuis l'Est",
    'Mer Rouge : Resort Somabay',
    'Réserver le Grand Musée en ligne (évite les files)',
  ]},
  {ic:'£', t:'Budget & Monnaie', items:[
    'Monnaie : Livre égyptienne (LE / EGP)',
    'Limite : 3 retraits maximum aux DAB par voyage',
    'Plafond DAB : 2 000–6 000 LE par retrait',
    'Repas local : 200–500 LE pour deux',
    'Repas restaurant moyen : 800–1500 LE pour deux',
    'Pyramides de Gizeh : 700 LE / personne',
    'Grand Musée Égyptien : ~25€ / personne',
    'Île de Philæ spectacle : 1 000 LE / personne',
  ]},
  {ic:'❀', t:'Nourriture & Santé', items:[
    'Commencer par un koshary au Caire : pâtes + riz + lentilles + sauce tomate, 100-200 LE pour deux',
    'Assouan : les restaurants nubiens de la corniche sont délicieux et peu chers',
    'Louxor : éviter les buffets exposés à la chaleur — préférer les plats préparés à la commande',
    "Éviter l'eau du robinet et les glaçons absolument",
    'Emporter : probiotiques, Smecta, Imodium, Doliprane',
    'Se méfier des jus « frais » des hôtes',
    'En cas de maladie : riz, bananes, eau en bouteille',
  ]},
  {ic:'☼', t:'Météo & Saison', items:[
    'Avril : 35–44°C selon les sites (Assouan le plus chaud)',
    'Soleil garanti, aucune précipitation',
    'SPF 50, chapeau, lunettes : indispensables',
    'Mer Rouge (Somabay) : eau à 22–23°C en avril',
    'Meilleure saison : octobre–mars (20–30°C)',
    'Vêtements amples, clairs, couvrants',
    'Le soir ça refroidit vite dans le désert',
  ]},
  {ic:'✧', t:'Culture & Conseils', items:[
    'Négocier systématiquement (souk, taxi, souvenirs)',
    'Les Égyptiens sont chaleureux et très curieux',
    "Saqqara > Pyramides en authenticité et frissons",
    'Vallée des Rois : prévoir 4–5 jours min à Louxor',
    'Louxor = archéologie à ciel ouvert permanente',
    'La croisière Nil : un must, le voyage dans le voyage',
    "Acheter les épices au Carrefour (moins cher qu'au souk)",
    "Sites immenses : beaucoup d'eau et des pauses",
  ]},
];
