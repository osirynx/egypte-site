...
window.INFOS = [
  {ic:'✈️', t:'Vols & Arrivée', items:[
    ...
    'Depuis Paris : vols directs vers Le Caire (~5h) avec EgyptAir, Air France, Lufthansa',
    'Vols charters directs vers Hurghada depuis nombreuses villes françaises',
    'Vols intérieurs Egypt Air / Air Cairo : Le Caire → Assouan ou Louxor (~1h, 40–80€)',
    "Arrivée au Caire : Uber recommandé depuis l'aéroport (300–400 LE vers le centre)",
  ]},
  {ic:'🛂', t:'Visa & Formalités', items:[
    '<strong>Visa obligatoire</strong> pour les ressortissants français — obtenir en ligne avant le départ',
    'E-visa (recommandé) : <strong>visa.egyptonline.eg</strong> — 25 USD, traitement en 3–5 jours',
    "Visa à l'arrivée possible (30 USD) mais files d'attente importantes",
    'Passeport valide 6 mois après la date de retour requis',
    'Assurance voyage avec rapatriement fortement recommandée',
  ]},
  {ic:'💷', t:'Budget & Monnaie', items:[
    'Monnaie : Livre Égyptienne (LE / EGP) — 1€ ≈ 40–45 LE (taux variable)',
    'Budget journalier moyen : <strong>60–100€/pers.</strong> (hébergement + repas + entrées)',
    'Budget confort : 100–150€/pers./jour — budget serré possible dès 40–50€',
    'Retrait DAB recommandé sur place (taux bancaire) — éviter les bureaux de change aéroport',
    'Carte bancaire acceptée dans les grands hôtels et musées, espèces pour le reste',
    'Pourboires : pratique culturelle importante — prévoir de la monnaie en petites coupures',
  ]},
  {ic:'🏨', t:'Hébergement', items:[
    '<strong>Le Caire</strong> : hôtels budget dès 20€, milieu de gamme 50–100€, Zamalek pour le calme',
    '<strong>Louxor</strong> : rive Ouest (près sites) ou rive Est (restaurants, vie nocturne)',
    '<strong>Assouan</strong> : hôtels avec vue Nil en catégorie supérieure, guest houses authentiques',
    '<strong>Mer Rouge</strong> : resorts all-inclusive dès 40–60€/pers./nuit en 3*, 80–150€ en 5*',
    'Croisière Nil : cabine standard 80–150€/pers./nuit tout inclus (repas compris)',
    "Réserver à l'avance en haute saison (novembre–avril)",
  ]},
  {ic:'🚖', t:'Transports', items:[
    '<strong>Uber</strong> : indispensable dans toutes les grandes villes — prix fixé, pas de négociation',
    '<strong>Train</strong> : Louxor → Assouan en 3h (~5€ en 1ère classe) — confortable et recommandé',
    '<strong>Vols intérieurs</strong> : Le Caire → Assouan ou Louxor (~1h) si le temps est compté',
    '<strong>Croisière Nil</strong> : option la plus belle pour relier Assouan et Louxor (3–4 nuits)',
    'Métro du Caire : propre, rapide, 10 LE le ticket — idéal pour les quartiers centraux',
    "Taxi Louxor → Hurghada : ~5h de route, ~1 500 LE — négocier à l'avance",
  ]},
  {ic:'🌡', t:'Météo & Saisons', items:[
    ...
    "Louxor / Assouan : toujours plus chaud qu'au Caire (jusqu'à 44°C en avril)",
  ...
  {ic:'🏥', t:'Santé & Sécurité', items:[
    ...
    '<strong>Eau du robinet : ne jamais boire</strong> — eau en bouteille uniquement',
    ...
    'Assurance avec couverture médicale et rapatriement obligatoire',
  ]},
  {ic:'📱', t:'Communication & SIM', items:[
    'Carte SIM locale recommandée : Vodafone ou Orange Égypte — ~10€ pour 10 Go',
    "S'acheter à l'aéroport (passeport requis) ou dans les grandes villes",
    'Wi-Fi disponible dans la plupart des hôtels — qualité variable',
    'Réseau 4G dans les villes, couverture limitée dans le désert',
    'WhatsApp fonctionne normalement — VPN non requis',
    'Prise de courant : type C (européenne) — pas besoin d\'adaptateur',
  ]},
  {ic:'🕌', t:'Culture & Usages', items:[
    'Pays musulman à majorité — respect des codes vestimentaires dans les lieux de culte',
    'Tenues couvrantes recommandées (épaules et genoux) pour les mosquées et certains sites',
    'Ramadan : ambiance différente, horaires des restaurants modifiés — à anticiper',
    ...
    'Photographier les militaires et bâtiments officiels : interdit',
  ]},
  {ic:'🔗', t:'Liens utiles', items:[
    '<a href="https://www.diplomatie.gouv.fr/fr/conseils-aux-voyageurs/conseils-par-pays-destination/egypte/" target="_blank" rel="noopener">Conseils aux voyageurs — Ministère des Affaires étrangères</a>',
    '<a href="https://visa.egyptonline.eg" target="_blank" rel="noopener">E-visa Égypte officiel</a>',
    '<a href="https://gem.gov.eg" target="_blank" rel="noopener">Billetterie officielle Grand Musée Égyptien (GEM)</a>',
    '<a href="https://uber.com" target="_blank" rel="noopener">Uber Égypte</a> — indispensable dans toutes les grandes villes',
  ]},
];
